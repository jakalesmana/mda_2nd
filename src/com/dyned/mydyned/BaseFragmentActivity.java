...
public class BaseFragmentActivity extends SherlockFragmentActivity {
	...
	private class OnClickHandler implements OnClickListener {
		...
		public void onClick(View v) {
			v.startAnimation(AnimationUtils.loadAnimation(BaseFragmentActivity.this, R.anim.image_click));
			v.postDelayed(new Runnable() {
				public void run() {	
					...
					case BACK:
						break;
					case LOGIN:
						startActivity(new Intent(BaseFragmentActivity.this, SignInActivity.class));
						break;
					}
				}
			}, 200);
