...
public class EventAdapter extends BaseAdapter {
	...
	public EventAdapter(Activity act, List<?> list) {
	...
	public View getView(int position, View convertView, ViewGroup viewGroup) {
		...
		imageLoader.displayImage(event.getImage(), holder.image, optionsAvatar, new AnimateFirstDisplayListener(event.getImage(), holder.image, false, 0, 0));
